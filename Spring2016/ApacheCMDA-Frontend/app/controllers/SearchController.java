...
public class SearchController extends Controller{
    ...
    public static Result index() {
        ...
        return ok(search.render(session("username"), session("id"), null, null, null, session("priviledge")));
    }
    ...
    public static Result search(String category, String keywd) {
        ...
        switch (category) {
            case "user":
                ...
                return ok(search.render(session("username"), session("id"), category, userArr, null, session("priviledge")));
            case "tag":
                ...
                return ok(search.render(session("username"), session("id"), category, null, wfArr, session("priviledge")));
            case "workflow":
                ...
                return ok(search.render(session("username"), session("id"), category, null, wfArrt, session("priviledge")));
        }

        return ok(search.render(session("username"), session("id"), category, null, null, session("priviledge")));
    }
}
