...
public class Application extends Controller {
    ...
    public static Result index() {
        ...
        return ok(home.render(session("username"), session("id"), session("priviledge")));
    }
    ...
    public static Result home() {
        if (notpass()){
            return ok(home.render("undefined", "-1", "undefined"));
        }
        return ok(home.render(session("username"), session("id"), session("priviledge")));
    }
    ...
    public static Result authenticate() {
        ...
        if (loginForm.hasErrors()) {
            ...
            session("priviledge", loginForm.data().get("priviledge"));
