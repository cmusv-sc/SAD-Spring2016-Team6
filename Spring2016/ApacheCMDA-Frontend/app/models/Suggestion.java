 ...
 */
public class Suggestion extends GeneralModel {
    ...
    public Suggestion(JsonNode node) {
        ...
        if (node.get("suggestionContent")!=null) content = node.get("suggestionContent").asText();
    ...
    public String toString() {return this.getContent(); }
