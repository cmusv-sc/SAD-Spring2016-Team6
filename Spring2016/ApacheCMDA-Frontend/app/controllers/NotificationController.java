...
public class NotificationController extends Controller {
    ...
    public static Result main()
    {
        ...
        return ok(notification.render(requests,inbox, outbox, session("username"), (session("id")),session("priviledge")));
    }
    ...
    public static Result pmdetailpage(Long id)
    {
        ...
        return ok(mail_detail.render(message, session("username"), session("id"),session("priviledge")));
    }
