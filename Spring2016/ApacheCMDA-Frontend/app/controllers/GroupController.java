...
public class GroupController extends play.mvc.Controller {
    ...
    public static Result create()
    {
        ...
        return ok(create_group.render(session("username"), Long.parseLong(session("id")), groupArr, session("priviledge")));
    }

    public static Result join()
    {
        return ok(join_group.render(session("username"), Long.parseLong(session("id")), session("priviledge")));
    }
