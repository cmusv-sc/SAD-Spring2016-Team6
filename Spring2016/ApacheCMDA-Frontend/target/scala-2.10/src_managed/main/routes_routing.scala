// @SOURCE:/sharedFolder/SA-D-Final-Code/Spring2016/ApacheCMDA-Frontend/conf/routes
// @HASH:5d41057c3e7f6ed4723c9aa0912db7d0645eff23
// @DATE:Fri Apr 29 06:40:51 UTC 2016
...
// @LINE:64
private[this] lazy val controllers_StatePatternDemo_main40 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("timeline/"),DynamicPart("offset", """[^/]+""",true))))
...
// @LINE:64
case controllers_StatePatternDemo_main40(params) => {
   call(params.fromPath[Long]("offset", None)) { (offset) =>
        invokeHandler(controllers.StatePatternDemo.main(offset), HandlerDef(this, "controllers.StatePatternDemo", "main", Seq(classOf[Long]),"GET", """""", Routes.prefix + """timeline/$offset<[^/]+>"""))
   }
}
...
// @LINE:76
case controllers_IteratorPatternDemo_main51(params) => {
   call(params.fromPath[Long]("wid", None)) { (wid) =>
        invokeHandler(controllers.IteratorPatternDemo.main(wid), HandlerDef(this, "controllers.IteratorPatternDemo", "main", Seq(classOf[Long]),"GET", """""", Routes.prefix + """workflow/nextpage/$wid<[^/]+>"""))
   }
}
        

// @LINE:78
case controllers_WorkflowController_addTag52(params) => {
...
// @LINE:79
case controllers_WorkflowController_deleteTag53(params) => {
   call(params.fromPath[Long]("wid", None), params.fromPath[String]("tg", None)) { (wid, tg) =>
...
// @LINE:80
case controllers_WorkflowController_parseXML54(params) => {
...
// @LINE:84
case controllers_GroupController_create55(params) => {
   call { 
...
// @LINE:85
case controllers_GroupController_createGroup56(params) => {
   call { 
...
// @LINE:86
case controllers_GroupController_join57(params) => {
   call { 
...
// @LINE:87
case controllers_GroupController_joinGroup58(params) => {
   call { 
...
// @LINE:91
case controllers_NotificationController_main59(params) => {
   call { 
...
// @LINE:92
case controllers_NotificationController_accpetFriend60(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:93
case controllers_NotificationController_rejectFriend61(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:94
case controllers_NotificationController_sendMessage62(params) => {
   call { 
...
// @LINE:95
case controllers_NotificationController_pmdetailpage63(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:96
case controllers_NotificationController_getNotifications64(params) => {
   call { 
...
// @LINE:99
case controllers_WorkflowController_addSuggestion65(params) => {
   call(params.fromPath[Long]("wid", None)) { (wid) =>
...
// @LINE:100
case controllers_WorkflowController_addSuggestionTag66(params) => {
...
// @LINE:101
case controllers_WorkflowController_voteToSuggestion67(params) => {
   call(params.fromPath[Long]("suggestionID", None)) { (suggestionID) =>
